...
public class ICache {
	...
	public ICache(int cycles, int cacheSize, int lineSize, int associativity,
			Type type, WritePolicy writePolicy) {
		this.cycles = cycles;
	...
	public Pair<Instruction, Integer> read(int address) {
		time += cycles;
